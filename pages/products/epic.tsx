...
const Product = () => (
  <PageLayout title='Produkte - EpicGames WebApp'>
    ...
    <SlideFade in={true} delay={0.6}>
      <CContainer>
        EpicGames WebApp ermöglicht es Spielern, sich über den Browser mit ihren
        Freunden zu verbinden. Auch ein Zugang zum Forum wird erleichtert.
      </CContainer>
      <List ml={4} my={4}>
        <ListItem>
          <Meta>Website</Meta>
          <Link
            href='https://www.epicgames.com/site/de/home'
            target='_blank'
            variant='colored'>
            https://www.epicgames.com/site/de/home <ExternalLinkIcon />
          </Link>
        </ListItem>
        <ListItem>
          <Meta>Plattform</Meta>
    ...
    <SlideFade in={true} delay={1.2}>
      ...
      <ProductImage
        src='/assets/images/products/epic/shop.jpg'
        alt='EpicGames Shop'
      />
