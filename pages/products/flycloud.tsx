...
const Product = () => (
  <PageLayout title='Produkte - FlyCloud Security'>
    ...
    <SlideFade in={true} delay={0.6}>
      <CContainer>
        Mit FlyCloud können Sie auf Ihre Daten und Ihre Anwendungen sicher und
        schnell Gerätübergreifend zugreifen. Wir haben dafür gesorgt, dass Sie
        sich keine Sorgen machen müssen, dass nicht-autorisierte Personen Ihre
        Daten sehen können.
      </CContainer>
      <List ml={4} my={4}>
        <ListItem>
          <Meta>Website</Meta>
          <Link
            href='https://www.flycloud.com/'
            target='_blank'
            variant='colored'>
            https://www.flycloud.com/ <ExternalLinkIcon />
          </Link>
        </ListItem>
        <ListItem>
          <Meta>Plattform</Meta>
